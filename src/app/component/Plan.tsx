...
export default function Plan() {
    return (
        <>
            <div className="space-y-[32px] p-[24px] border-2 rounded-2xl w-[320px] h-[453.38px]">
                ...
                <button className="w-[272px] h-[42px] text-center text-[15px] font-medium bg-[rgba(84,88,102,0.1)] rounded-2xl">Start free</button>
                <div>
