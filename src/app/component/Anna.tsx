export default function Anna() {
    return (
        <>
            <div className="w-[409.6px] min-w-[409.6px] h-[446.19px] border-2 pl-6 flex flex-col justify-evenly flex-shrink-0">
                <div className="flex space-x-4 items-center">
                    <img src="/profile.png" className="w-[80px] h-[80px]" />
                    <div>
                        <h1 className="font-semibold text-[15.8px]">Anna Magar</h1>
                        <h1 className="text-[13.6px]">CEO</h1>
                    </div>
                </div>
                ...
                <div className="flex flex-col justify-evenly">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <h1 className="text-[15.6px]">Nepal</h1>
                    </div>
                </div>
            </div>
        </>
