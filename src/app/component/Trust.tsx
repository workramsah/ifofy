    ...
    return (
        <>
            <div className="flex flex-col items-center">
                <div className="text-[20px] text-[rgba(112,124,140,1)]">Trusted businesses partner</div>
                <div>
                    <h1 className="text-[58px] font-bold text-[rgba(229,111,30,1)]">Create invoice instintly</h1>
                    <h1 className="text-[58px] font-bold text-[rgba(9,30,67,1)]">& Store Online easily</h1>
                </div>
